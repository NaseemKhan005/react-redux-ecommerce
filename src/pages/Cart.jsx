	...
	return (
		<div className="container mx-auto px-5 md:px-10 pb-16 pt-10">
			<div>
				...
				<div className="flex text-center md:items-center justify-between flex-col md:flex-row gap-3 md:gap-0 my-10">
					<Link
						to="/"
					...
					<div className="flex justify-center items-center gap-4 sm:text-base text-sm order-1 md:order-2">
						<p className="underline">Shopping Bag({cart.length})</p>
				...
				<div className="flex flex-col lg:flex-row lg:items-start justify-between gap-10 sm:gap-16 lg:gap-5 relative mt-20">
					<div className="flex-1 w-full flex flex-col gap-10">
						{cart.length <= 0 && (
							<h1 className="text-center text-xl md:text-2xl font-medium capitalize">
								your cart is empty 😊
							</h1>
						)}
						{cart.map((product) => (
							<div
								key={product.id}
								className="flex flex-col sm:flex-row gap-5 border-b pb-5 justify-between"
							>
								<img
									src={product.image}
									alt={product.title}
								...
								<div className="flex flex-col justify-between flex-1">
									...
									<p className="bg-primary text-white w-fit p-1 rounded-md text-sm capitalize">
										{product.category}
									</p>
								</div>
								...
								<div className="flex sm:flex-col justify-between sm:items-end">
									...
									<div className="flex items-center gap-2">
										...
										<button
											...
											className="text-xl text-red-500 p-2 rounded-full hover:bg-red-500/10"
										>
											<FiTrash2 />
										</button>
									</div>
